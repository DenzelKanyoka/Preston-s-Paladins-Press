...
var links;
//This array is for <label> elements
var labels;
...
document.getElementById("readable_text_button_contact").onclick = function(){
...
document.getElementById("font_size_contact").onclick = function(){
...
function family(){
    ...
    for (var i = 0 ; i < labels.length ; i++){
        labels[i].style.fontFamily = "Jura"
    }
...
function family_undo(){
    ...
    for (var i = 0 ; i < labels.length ; i++){
        labels[i].style.fontFamily  = "Sofia"
    }
...
function size(){
    ...
    for (var i = 0 ; i < labels.length ; i++){
        labels[i].style.fontSize = "30px";
    }
    
    //The font size of the button is changed directly because there
    //is only one of it
    document.getElementById("message_button").style.fontSize = "30px";
}
...
function size_undo(){
    ...
    for (var i = 0 ; i < labels.length ; i++){
        labels[i].style.fontSize = "initial";
    }
    
    //The font size of the button is changed directly because there
    //is only one of it
     document.getElementById("message_button").style.fontSize = "14px";
}
