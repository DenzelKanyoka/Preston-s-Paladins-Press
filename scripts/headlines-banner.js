...
document.getElementById("community_headlines_banner").onmouseenter = function(){
	clearInterval(startBannerLoop);
}

//When the mouse leaves the banner, then banner begins to loop again.
document.getElementById("community_headlines_banner").onmouseleave = function(){
...
document.getElementById("headline_button_previous").onclick = function(){
...
document.getElementById("headline_button_next").onclick = function(){
	bannerLoop();
}
...
function bannerLoop(){
	...
	if(bannerStatus === 1){
		...
		document.getElementById("community_image_banner_2").style.opacity = "0";
		...
		setTimeout(function(){
			document.getElementById("community_image_banner_1").style.right = "0px";
			document.getElementById("community_image_banner_1").style.zIndex = "1000";
			document.getElementById("community_image_banner_2").style.right = "-1200px";
			document.getElementById("community_image_banner_2").style.zIndex = "1500";
			document.getElementById("community_image_banner_3").style.right = "1200px";
			document.getElementById("community_image_banner_3").style.zIndex = "500";
		...
		setTimeout(function(){
			document.getElementById("community_image_banner_2").style.opacity = "1";
		}, 1000);
	...
	//Else Do the same if it is this status
		...
		document.getElementById("community_image_banner_3").style.opacity = "0";
		setTimeout(function(){
			document.getElementById("community_image_banner_2").style.right = "0px";
			document.getElementById("community_image_banner_2").style.zIndex = "1000";
			document.getElementById("community_image_banner_3").style.right = "-1200px";
			document.getElementById("community_image_banner_3").style.zIndex = "1500";
			document.getElementById("community_image_banner_1").style.right = "1200px";
			document.getElementById("community_image_banner_1").style.zIndex = "500";
		},  500);
			
		setTimeout(function(){
			document.getElementById("community_image_banner_3").style.opacity = "1";
		}, 1000);
	...
	//Else Do the same if it is this status
		...
		document.getElementById("community_image_banner_1").style.opacity = "0";
		setTimeout(function(){
			document.getElementById("community_image_banner_3").style.right = "0px";
			document.getElementById("community_image_banner_3").style.zIndex = "1000";
			document.getElementById("community_image_banner_1").style.right = "-1200px";
			document.getElementById("community_image_banner_1").style.zIndex = "1500";
			document.getElementById("community_image_banner_2").style.right = "1200px";
			document.getElementById("community_image_banner_2").style.zIndex = "500";
		},  500);
		
		setTimeout(function(){
			document.getElementById("community_image_banner_1").style.opacity = "1";
		}, 1000);
