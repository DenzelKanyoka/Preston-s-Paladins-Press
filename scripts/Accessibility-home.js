...
document.getElementById("readable_text_button_home").onclick = function(){
...
document.getElementById("font_size_home").onclick = function(){
...
function family(){
    ...
    //The font family for the table element is changed directly since there
    //is only one of it
    document.getElementById("home_article_section_2_table").style.fontFamily ="Jura";
}
...
function family_undo(){
    ...
    //The font family for the table element is changed directly since there
    //is only one of it
    document.getElementById("home_article_section_2_table").style.fontFamily = "Sofia";
...
function size(){
    ...
    //The font size for the table element is changed directly since there
    //is only one of it
    document.getElementById("home_article_section_2_table").style.fontSize = "20px";
}
...
function size_undo(){
    ...
    //The font size for the table element is changed directly since there
    //is only one of it
    document.getElementById("home_article_section_2_table").style.fontSize = "initial";
}
